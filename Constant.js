export const ChatTitle = "دستیار هوش مصنوعی"; 
export const FooterAreaTitle = "متعلق به امیر وزیری";
export const PagebarTitle = "دستیار هوش مصنوعی یوز";

export const AIChatBotName = "دستیار هوش مصنوعی";
export const UserName = "امیر";

export const Avatar_User_Path = './Img/User-Avatar.png';
export const Avatar_AI_Path = './Img/Ai-Avatar.avif';

export const Button_Send_BackgroundColor = '#000';
export const Button_Send_Color = '#fff';
export const Button_Send_Text = 'ارسال';
